...
import contactUsBgImg from '../../assets/images/contactUsBg.png'
      ...
      <Grid container marginY={10}>
        <Grid
          ...
          sx={{
            ...
            overflow: 'hidden',
            backgroundImage: `url('${contactUsBgImg.src}')`,
        ...
        >
          <Box display={'flex'} flexDirection={'row'} marginY={6}>
            ...
            <Box>
              ...
              />
              <CustomText
                text={'De Ruijterkade 7'}
                color={'#fff'}
                fontSize={16}
              />
              <CustomText
                text={'1013 AA Netherlands'}
                color={'#fff'}
                fontSize={16}
              />
            </Box>
          ...
          <Box display={'flex'} flexDirection={'row'} marginBottom={5}>
            ...
            <CustomText
              text={'Info@opensourceconsulting.com'}
              color={'#fff'}
              fontSize={16}
            />
          </Box>
